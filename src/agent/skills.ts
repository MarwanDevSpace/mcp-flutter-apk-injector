...
export const EMBEDDED_SKILLS: Record<string, AgentSkill> = {
  "hermes-apk-reverse-engineering": {
    name: "hermes-apk-reverse-engineering",
    description:
      "Master Android & Game reverse engineering, DEX/Smali stack balance refactoring, native .so library symbol tracing, Lua/asset script modding, and seamless Flutter runtime overlay injection.",
    markdownContent: `---
name: hermes-apk-reverse-engineering
...
`,
  ...
  "mcp-toolchain-orchestrator": {
    name: "mcp-toolchain-orchestrator",
    description:
      "Orchestrate high-precision MCP toolchain pipelines, agent slash commands (/scan, /decompile, /inject, /patch, /recompile, /pipeline), and automated build/publish workflows.",
    markdownContent: `---
name: mcp-toolchain-orchestrator
